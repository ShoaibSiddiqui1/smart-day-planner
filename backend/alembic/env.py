...
Loads DATABASE_URL from .env and uses the SQLAlchemy metadata from our models
so that `alembic revision --autogenerate` detects schema changes automatically.
"""
import os
import sys
